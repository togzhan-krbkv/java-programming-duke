/**
 * QuakeSortInPlace, several ways to sort earthquake data in place: a
 * selection sort by magnitude, a selection sort by depth, a bubble sort by
 * magnitude, and versions of each that stop early once the list is sorted.
 *
 * @author Togzhan K.
 */
import java.util.*;
