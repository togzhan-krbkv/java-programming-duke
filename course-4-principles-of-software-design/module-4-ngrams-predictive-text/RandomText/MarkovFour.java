/**
 * MarkovFour, a fixed order 4 Markov model: generates each character based
 * on the 4 characters that precede it in the training text. This is the
 * standalone version before the code was refactored to share a common
