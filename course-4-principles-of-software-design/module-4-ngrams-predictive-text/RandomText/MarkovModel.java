/**
 * MarkovModel, an order n Markov model: generates each character based on
 * the n characters that precede it in the training text, where n is
 * configurable through the constructor. This is the standalone version
 * before the code was refactored to share a common interface and abstract
 * base class.
 *
 * @author Togzhan K.
 */
