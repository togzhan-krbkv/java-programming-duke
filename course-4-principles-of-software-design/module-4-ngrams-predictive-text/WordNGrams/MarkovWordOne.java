/**
 * MarkovWordOne, an order 1 word level Markov model: generates text one
 * word at a time, choosing each next word based on the single word that
 * precedes it in the training text.
 *
 * @author Togzhan K.
 */
import java.util.*;
