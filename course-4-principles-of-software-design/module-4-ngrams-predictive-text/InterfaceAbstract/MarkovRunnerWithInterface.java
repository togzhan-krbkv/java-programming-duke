/**
 * MarkovRunnerWithInterface, runs and times different Markov model
 * implementations (orders 0, 1, n, 4, and the HashMap based efficient
 * model) against a training text, treating them interchangeably through
 * the IMarkovModel interface.
 *
 * @author Togzhan K.
 */
import edu.duke.*;
